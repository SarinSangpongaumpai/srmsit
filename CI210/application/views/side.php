        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="#"><i class="fa fa-angle-double-right"></i> Participant</a></li>
                <li><a href="#"><i class="fa fa-angle-double-right"></i> Not Participant</a></li>
              </ul>
            </li>
            <li >
              <a href="<?php echo site_url('upload/index'); ?>">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo site_url('table/index'); ?>"><i class="fa fa-angle-double-right"></i>School</a></li>
                <li><a href="pages/tables/data.html"><i class="fa fa-angle-double-right"></i> SIT'SRM Activities</a></li>
              </ul>
            </li>
            <li>
             ...
             <li>
              <a href="<?php echo site_url('event/index'); ?>">
                <i class="fa fa-edit"></i> <span>Event Setting</span>
              </a>
            </li>
          </ul>
        <!-- /.sidebar -->
