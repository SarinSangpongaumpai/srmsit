<div class="well">
    ...
    <form class="form" id="frmupdate" role="form" action="<?php echo base_url() ?>table/update" method="POST">
    <?php foreach($query->result() as $row):?>
                          ...
                          <div class="form-group">
                            ...
                            <select id = "school_year" name = "school_year"  class="form-control" >
                                <option selected value="<?php echo $row->school_year ?>">
                           ...
                           <div class="form-group">
                            ...
                            <select id="program" name = "program"  class="form-control" >
                                <option selected value="<?php echo $row->program ?>">
...
$(document).ready(function (){
    $("#frmupdate").submit(function(e){
        e.preventDefault();
        $.ajax({
            url:'<?php echo base_url() ?>table/update',
            type:'POST',
            dataType:'json',
